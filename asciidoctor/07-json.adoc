...
$ curl -X POST -H 'Content-type: application/json' --data '{"title":"Learn Ratpack"}' http://localhost:5050/
{"id":2,"title":"Learn Ratpack","completed":false,"order":null,"url":"null/2"}

$ curl http://localhost:5050/blocking
[{"id":1,"title":"New Task","completed":false,"order":null,"url":"null/1"},{"id":2,"title":"Learn Ratpack","completed":false,"order":null,"url":"null/2"}]
----
...
$ curl -X POST -H 'Content-type: application/json' --data '{"title":"Learn Ratpack"}' --raw -v -s http://localhost:5050/
...
$ curl -X POST -H 'Content-type: application/json' --data '{"title":"Learn Ratpack"}' http://localhost:5050/
{"id":1,"title":"Learn Ratpack","completed":false,"order":null,"url":"null/1"}
